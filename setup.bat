...
cls
echo =================================================================
echo    Kaisar BOT SETUP AND RUN SCRIPT by @MeoMunDep
echo =================================================================
echo.
...
if exist "..\node_modules" (
    ...
    npm install user-agents axios meo-forkcy-utils meo-forkcy-colors meo-forkcy-proxy meo-forkcy-logger
    cd %~dp0
) else (
    echo Installing dependencies in current directory...
    npm install user-agents axios meo-forkcy-colors meo-forkcy-utils meo-forkcy-proxy meo-forkcy-logger
)
echo.
